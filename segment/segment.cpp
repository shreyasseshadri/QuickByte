...
void Segment::writeToSegment(std::string key, std::string value)
{
    if (indexer == NULL)
    {
    ...
    std::cout << "Segment Size Left: "<< " " <<  segmentSizeLeft << "\n";
}

std::pair<bool,std::string> Segment::readFromSegment(std::string key)
{
